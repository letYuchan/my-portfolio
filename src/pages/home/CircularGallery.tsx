...
class App {
  ...
  baseItems: { image: string; text: string }[] = []; // ⭐ 원본 items 저장
  ...
  private getActiveIndex(): number {
    // ⭐ 현재 scroll 기준 중앙 카드 index 계산
    if (!this.medias.length || !this.baseItems.length) return 0;
  ...
  createMedias(
    ...
    this.baseItems = galleryItems; // ⭐ 원본 저장
  ...
  addEventListeners() {
    ...
    this.boundOnTouchUp = this.onTouchUp.bind(this); // ⭐ 시그니처 변경 대응
